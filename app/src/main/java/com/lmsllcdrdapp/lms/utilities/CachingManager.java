...
public class CachingManager {
    ...
    public void saveToken(Token token) {
        if (token == null)
            return;
        String itemFileName = Engine.FileName.APP_TOKEN;
        File containerFolder = Engine.DataFolder.TOKEN_DATA;
        saveObject(itemFileName, containerFolder, token, BaseApplication.getContext());
    ...
    public void deleteToken() {
        Engine.deleteFileRecursive(Engine.DataFolder.TOKEN_DATA);
    }
