package com.lmsllcdrdapp.lms.utilities;
...
import com.lmsllcdrdapp.lms.dialogs.ProgressViewDialog;
import com.lmsllcdrdapp.lms.helpers.Logger;
import com.lmsllcdrdapp.lms.helpers.SharedPreferenceData;
import com.lmsllcdrdapp.lms.managers.LocaleManager;
...
public class Utilities {
    ...
    public static String formatTime(String dateStr) {
        ...
        @SuppressLint("SimpleDateFormat")
        SimpleDateFormat timeLocaleFormat = new SimpleDateFormat("hh:mm a");

        Date dt;
        String displayTime;
        try {
            dt = timeFormat.parse(time);
            displayTime = timeLocaleFormat.format(dt);
